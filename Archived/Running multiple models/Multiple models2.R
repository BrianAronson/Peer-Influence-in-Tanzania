      ...
      #subset data
          ...
          #decent jaccard
              # sumstats3<-sumstats3[sumstats3$ffjaccard>.15,]
                ...
                if(options$DVname=="ipvoutcome_bin"){
                  sumstats3<-sumstats3[sumstats3$d.ipvbin>.15,]
                }
              ...
              # sumstats3<-sumstats3[setdiff(c(1:nrow(sumstats3)),c(5,17)),]
              # dataset2<-dataset2[c(1,3,5:9)]
              # sumstats3<-sumstats3[c(1,3,5:9),]
              sumstats3<-sumstats3[setdiff(c(1:nrow(sumstats3)),c(5,6)),] #too much churn in outdegree distribution; this is for N>30
...
myalgorithm <- sienaAlgorithmCreate( projname = 'SingleGroups', useStdInits = FALSE, nsub=3, n3=2000,cond = F) #, MaxDegree = c(friendship=3)
    ...
    #choose effects to test
      ...
      #interactions
      # m0 <- includeInteraction(m0, density, egoX, interaction1 = c('','campn'),name="friendship")
      # m0 <- includeInteraction(m0, Jout, egoX, interaction1 = c('','campn'),name="friendship")
      # m0 <- includeInteraction(m0, outPopSqrt, egoX, interaction1 = c('','campn'),name="friendship")
      # m0 <- includeInteraction(m0, inPopSqrt, egoX, interaction1 = c('','campn'),name="friendship")
    ...
    #run
      ...
      (timetest<-sienaTimeTest(Model,effects = c(19:20)))
