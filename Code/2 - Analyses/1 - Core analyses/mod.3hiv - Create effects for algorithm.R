...
#3 - Behavior
  ...
  #percent women in camp?        
        
        # myeff <- includeEffects(myeff, effFrom, interaction1 = "has.children", name = "DV") #no effect
        #myeff <- includeEffects(myeff, effFrom, interaction1 = "ever.test", name = "DV")
        #myeff <- includeInteraction(myeff, linear, effFrom, interaction1 = c('','d.hiv'),name="DV")
        #myeff <- includeEffects(myeff, indeg, interaction1 = "friendship", name = "DV") #no effect
        #myeff <- includeEffects(myeff, effFrom, interaction1 = "sex.num", name = "DV")
        ...
        # myeff <- includeEffects(myeff, avWAlt, interaction1 = "friendship", interaction2 = "dy.hivtstf", name = "DV")
        # myeff <- includeEffects(myeff, avWAlt, interaction1 = "friendship", interaction2 = "dy.hivinjf", name = "DV")
        # myeff <- includeEffects(myeff, avWAlt, interaction1 = "friendship", interaction2 = "dy.hivadvf", name = "DV")
...
#        myalgorithm <- sienaAlgorithmCreate( projname = 'SingleGroups', useStdInits = FALSE, nsub=4, n3=2000, MaxDegree = c(friendship=4),cond = F, firstg=.02, doubleAveraging=2)#, MaxDegree = c(friendship=3)
    }, file='NUL')
...
#5 - Optionals
    ...
    # myeff[myeff$include==T,][grep("rate DV",a),]$initialValue<-2
