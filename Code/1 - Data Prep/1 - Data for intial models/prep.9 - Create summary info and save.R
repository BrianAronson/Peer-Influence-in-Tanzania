...
#Create objects to save
    ...
    saveRDS(sumstats,"sumstats.rds")
    saveRDS(sumstats2,"sumstats2.rds")
    saveRDS(varlist,"varlist.rds")
# 
#     
#     sumstats3<-readRDS("sumstats2.rds")
# 
#     summary(sumstats2$ffjaccard)
#     summary(sumstats3$ffjaccard)
    # summary(sumstats2$ffjaccard[sumstats2$N>30])
    # summary(sumstats3$ffjaccard[sumstats2$N>30])
#     
#     sumstats2$ffjaccard[paste(sumstats2$Camp,sumstats2$Wave)%in% paste(sumstats3$Camp,sumstats3$Wave)]
#     
    
    # (sumstats2$ffjaccard[sumstats2$N>30])
    # a1<-temp
    # a2<-temp2
    # 
    # a1
