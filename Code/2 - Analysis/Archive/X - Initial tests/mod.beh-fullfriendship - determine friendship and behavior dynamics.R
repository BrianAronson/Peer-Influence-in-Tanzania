...
#I - Load data
  ...
  #2 - Choose DV
      options$DVname<-"all_ipv" #gem_r15_avg ipvoutcome_cat alc_freq testhiv_12 all_ipv
  ...
  #4 - Remove unecessary stuff from environment
      rm(list=setdiff(ls(), c("dataset","options","sumstats","sumstats2","goodcamps","SaveResults","ml")))
...
#II - subset data
      ...
      datasetg <- sienaGroupCreate(dataset2[c(2,4,6:19)][-12][-4])
